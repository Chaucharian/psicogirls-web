      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {team.map((member, i) => (
            <div 
              key={i} 
              className={`bg-white rounded-2xl shadow-sm border border-gray-100 p-8 hover:shadow-md transition-all duration-700 ease-out transform hover:scale-105 ${
                isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
              }`}
            ...
            >
              <div className="text-center mb-6">
                <div className="relative w-32 h-32 mx-auto mb-4 group">
                  <Image 
                    ...
                    width={128} 
                    height={128} 
                    className="w-32 h-32 rounded-full object-cover border-4 border-secondary/40 transition-all duration-300 group-hover:border-secondary/60 group-hover:scale-105" 
                  />
                  <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-secondary rounded-full flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
              ...
              <button className="w-full bg-white border-2 border-gray-200 text-gray-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 hover:border-gray-300 transition-all duration-300 transform hover:scale-105">
                {member.cta}
              </button>
            </div>
          ))}
        ...
        <div className={`mt-16 bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100 transition-all duration-1000 ease-out transform ${
          isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              {[
                { icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z", text: "100% online", bg: "bg-secondary/30" },
                { icon: "M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z", text: "Profesionalismo", bg: "bg-accent/30" },
                { icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z", text: "Adaptabilidad horaria", bg: "bg-accent-blue/30" },
                { icon: "M15 12a3 3 0 11-6 0 3 3 0 016 0zM2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z", text: "Seguimiento personalizado", bg: "bg-accent/30" },
                { icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z", text: "Terapias basadas en evidencia", bg: "bg-primary/30" },
                { icon: "M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z", text: "Comunicación fluida", bg: "bg-secondary/30" }
              ].map((item, index) => (
                <div 
                  key={index} 
