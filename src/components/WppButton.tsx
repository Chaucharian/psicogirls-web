...
export const WppButton = () => {
  ...
  return (
    <button 
      ...
      className="bg-[#25D366] rounded-full p-4 shadow hover:bg-[#25D366]/80 transition flex items-center"
    >
      <svg 
