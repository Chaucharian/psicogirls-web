  ...
  return (
    <section className="w-full relative flex items-center justify-center px-4 md:px-16 py-24 min-h-[600px] mt-16">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <p className="text-white text-lg md:text-xl mb-8 max-w-2xl mx-auto leading-relaxed font-sans">
        ...
        <Link 
          href="/#contacto" 
          className="inline-flex items-center px-8 py-4 border-2 border-gray-200 text-gray-600 bg-white rounded-lg font-semibold shadow-sm hover:bg-gray-100 hover:border-gray-300 transition-all duration-200"
        >
