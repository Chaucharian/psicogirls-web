    ...
    <section id="terapia" className="w-full bg-background py-20 px-4 md:px-16">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-gray-600 mb-6">¿Cómo te puedo ayudar?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="text-center p-6 rounded-xl bg-secondary/20 hover:bg-secondary/30 transition-colors">
          ...
          <div className="text-center p-6 rounded-xl bg-accent/20 hover:bg-accent/30 transition-colors">
          ...
          <div className="text-center p-6 rounded-xl bg-accent-blue/20 hover:bg-accent-blue/30 transition-colors">
          ...
          <div className="text-center p-6 rounded-xl bg-primary/20 hover:bg-primary/30 transition-colors">
